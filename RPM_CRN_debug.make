...
CFLAGS= -g -c -Wall -Wextra -pedantic -ffast-math $(INCDIR)
LDFLAGS= -g -Wall -ffast-math

# SOURCE FILES MACROS IN DEPENDENCY ORDER? SHOULDNT MATTER THANKS TO HEADERS
SOURCES = ./src/FastExp.cpp ./src/RockyCoastCRN.cpp ./src/SeaLevel.cpp ./src/RPM.cpp ./src/Parameters.cpp ./driver_files/RPM_CRN_Driver.cpp
