...
int main(int nNumberofArgs,char *argv[])
{
    ...
    string OutputMorphologyFileName = Folder+"CF_"+tostr(CliffFailureDepth)
                                                +"_EnsembleShoreProfile.xz";
                                        
    string OutputConcentrationFileName = Folder+"CF_"+tostr(CliffFailureDepth)
