...
Launchstr = " ./RPM_dakota.out /home/lguest/DAKOTA/  "+ sys.argv[2] +"  0  "+ str(Gradient) +" "+ str(TidalRange) +" "+ str(SubtidalEfficacy) +" "+ str(WaveAttenuationConst) +" "+ str(Resistance) +" "+ str(WeatheringRate) +"" 
print(Launchstr) 
