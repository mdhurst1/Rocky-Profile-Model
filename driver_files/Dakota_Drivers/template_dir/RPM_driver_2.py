...
Launchstr = "../RPM_dakota.exe /dakotaQuesoWorking/Rocky-Profile-Model/driver_files/Dakota_Drivers/ "+ sys.argv[2] +" /dakotaQuesoWorking/Rocky-Profile-Model/driver_files/Data/CB_profile.txt /dakotaQuesoWorking/Rocky-Profile-Model/driver_files/Data/CB_CRN.data 0 "+ str(Gradient) +" "+ str(TidalRange) +" "+ str(SubtidalEfficacy) +" "+ str(WaveAttenuationConst) +" "+ str(Resistance) +" "+ str(WeatheringRate)
