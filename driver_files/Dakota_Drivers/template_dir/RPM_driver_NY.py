...
#set folder location 
Folder = "/home/jrs17/COAST/Rocky-Profile-Model/driver_files/"
...
Launchstr = "../RPM_dakota.exe "+ Folder+'Dakota_Drivers/' +" "+ sys.argv[2] +" "+ Folder+'Data/NY_profile.txt' +" "+ Folder+'Data/NY_CRN.data' +" 1 "+ str(Gradient) +" "+str(TidalRange) +" "+ str(SubtidalEfficacy) +" "+ str(WaveAttenuationConst) +" "+ str(Resistance) +" "+ str(WeatheringRate) 
