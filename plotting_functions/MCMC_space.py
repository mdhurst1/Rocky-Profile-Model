...
def make_plot(FileName,ColourMap):
    ...
    MCMCFileName = "../driver_files/CB_test_2.out"
    ...
    plt.show()
    #plt.draw()
    #fig1.savefig('MCMC_CB_test2.png',dpi=300)



if __name__ == "__main__":
     FileName = "../driver_files/CB_test_2.out" # /Users/jennyshadrick/RPM_JRS
     ColourMap = cm.gray
